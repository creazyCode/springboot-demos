...
import com.doaction.demo.common.pojo.HttpResult;
...
public class HttpUtil {
    ...
    public static HttpResult doGet(String url, Map<String, Object> params, Map<String, String> headers) {
        ...
        HttpResult requestResult = new HttpResult();
        String apiUrl = url;
     ...
     * @return
     */
    public static HttpResult doPost(String url, Object json) {
     ...
     * @return
     */
    public static HttpResult doPost(String url, Object json, Map<String, String> headers) {
        CloseableHttpClient httpClient = HttpClients.custom().setDefaultRequestConfig(requestConfig).build();
        HttpResult requestResult = new HttpResult();
        String httpStr = null;
        HttpPost httpPost = new HttpPost(url);
     ...
     * @return
     */
    public static HttpResult doPostSSL(String url) {
     ...
     * @return
     */
    public static HttpResult doPostSSL(String url, Map<String, Object> params) {
     ...
     * @return
     */
    public static HttpResult doPostSSL(String url, Map<String, Object> params, Map<String, String> headers) {
     ...
     * @return
     */
    public static HttpResult doPostSSL(String url, Object json) {
     ...
     * @return
     */
    public static HttpResult doPostSSL(String url, Object json, Map<String, String> headers) {
        CloseableHttpClient httpClient = HttpClients.custom().setSSLSocketFactory(createSSLConnSocketFactory()).setConnectionManager(connMgr).setDefaultRequestConfig(requestConfig).build();
        HttpResult requestResult = new HttpResult();
        HttpPost httpPost = new HttpPost(url);
        CloseableHttpResponse response = null;
     ...
     * @return
     */
    public static HttpResult doGetSSL(String url) {
     ...
     * @return
     */
    public static HttpResult doGetSSL(String url, Map<String, Object> params) {
     ...
     * @return
     */
    public static HttpResult doGetSSL(String url, Map<String, Object> params, Map<String, String> headers) {
     ...
     * @return
     */
    public static HttpResult put(String url, Map<String, String> params, Map<String, String> headers) {
        CloseableHttpClient client = HttpClients.custom().setDefaultRequestConfig(requestConfig).build();
        String responseText = "";
        HttpEntity entity = null;
        HttpResult requestResult = null;
        CloseableHttpResponse response = null;
        String httpStr = null;
        try {
     ...
     * @return
     */
    public static HttpResult doPut(String url, Object json) {
     ...
     * @return
     */
    public static HttpResult doPut(String url, Object json, Map<String, String> headers) {
        CloseableHttpClient httpClient = HttpClients.custom().setDefaultRequestConfig(requestConfig).build();
        HttpResult requestResult = new HttpResult();
        HttpPut httpPut = new HttpPut(url);
        CloseableHttpResponse response = null;
     ...
     * @return
     */
    public static HttpResult doDelete(String url, Map<String, String> params, Map<String, String> headers) {
        CloseableHttpClient client = HttpClients.custom().setDefaultRequestConfig(requestConfig).build();
        String responseText = "";
        HttpEntity entity = null;
        HttpResult requestResult = null;
